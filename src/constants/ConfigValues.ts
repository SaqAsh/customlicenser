...
export const TEMPLATE_DIRECTORY = "license-templates";
...
export const ERROR_MESSAGES = {
    ...
    NO_TEMPLATE_PATH: "No template path found for license type:",
    TEMPLATE_DIRECTORY_NOT_FOUND: "Template directory not found",
    TEMPLATE_FILE_NOT_FOUND: "Template file not found:",
    FAILED_TO_READ_TEMPLATE: "Failed to read template file:",
